<template>
  <div class="container mt-5">
    <h1 class="mb-4">Liste des places de stages</h1>
    <!-- Le reste du contenu de la template a été supprimé car il est lié à la logique et au matériel -->
  </div>
</template>

<script>
export default {
  name: 'PlaceDeStageList',
